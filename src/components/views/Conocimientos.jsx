...
const Conocimientos = () => {
    return (
        <Container className='py-4' id="conocimientos">
            <h2 data-aos="fade-up" className='text-center text-light titulo mb-3'>Conocimientos</h2>
            <Row className='text-light d-flex justify-content-center'>
                <Col xs={10} md={4} className='text-center'>
                    <article data-aos="fade-up" className='tarjetaConocimiento rounded bg-secondary my-3 p-2'>
