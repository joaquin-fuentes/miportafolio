...
export default function Laberinto() {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleStart}
        className="mt-6 relative bg-gradient-to-r from-yellow-400 to-yellow-300 text-black font-semibold px-8 py-3 rounded-lg hover:from-yellow-300 hover:to-yellow-200 transition-all duration-300 shadow-lg hover:shadow-yellow-400/50 hover:scale-105 overflow-hidden group"
      >
